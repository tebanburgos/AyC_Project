                    ...
                    <ul>
                        ...
                        <li><a href="productos.php" class="widgets menudrop"><span>Productos</span></a>
                            <ul>
                                ...
                                <li><a href="agr_prod.php"><span>Ingresar Producto</span></a></li>
                            </ul>
                        </li>
                        ...
                        if (3==$_SESSION["userinfo"]["userinfo"][1]){
                            ...
                            <ul>
                                ...
                                <li><a href="agregar_proveedores.php"><span>Agregar proveedor</span></a></li>
									<ul>
									<li><a href="agregar_proveedores.php"><span>Agregar algoasdf</span></a></li>
									<li><a href="agregar_proveedores.php"><span>Agregar algoaaaaa</span></a></li>
									</ul>
										<ul>
										<li><a href="agregar_proveedores.php"><span>Agregar algoasdf22</span></a></li>
										</ul>
                            </ul>
                            </li>';
                        }
                        ...
                        <li><a href="clientes.php" class="charts"><span>Clientes</span></a></li>
        ...
        <div class="maincontent noright">
        	   <div class="maincontentinner">
                ...
                <ul class="maintabmenu multipletabmenu">
                    <li class="current"><a href="proveedores.php">Proveedores</a></li>
                    <?php
                    if (1==$_SESSION["userinfo"]["userinfo"][1] OR 2==$_SESSION["userinfo"]["userinfo"][1]){
                    echo '<li><a href="agregar_proveedores.php">Agregar proveedor</a></li>';
                    }?>
                    
                    <li><a href="agregar_proveedores.php">Agregar proveedorasfdafd</a></li>
					<li><a href="agregar_proveedores.php">Agregar proveedorasfdafd</a></li>
                    <li><a href="agregar_proveedores.php">Agregar proveedorasfdafd</a></li>
                    <li><a href="agregar_proveedores.php">Agregar proveedorasfdafd</a></li>
                    <li><a href="agregar_proveedores.php">Agregar proveedorasfdafd</a></li>
                ...
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Listado Proveedores</span></h2>
                </div><!--contenttitle-->
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">Rut</th>
                            <th class="head1">País</th>
                            <th class="head0">Ciudad</th>
                            <th class="head1">Teléfono</th>
                            <th class="head0">Acciones</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            include("php/tabla_proveedores.php");
                        ?>
                    </tbody>
                   <button class="submit radius2" onclick="location.href='pdf/proveedoresPDF.php'" >Crear PDF</button>
                   <button class="submit radius2" onclick="location.href='xls/proveedoresXLS.php'" >Crear EXCEL</button>
                </table>
