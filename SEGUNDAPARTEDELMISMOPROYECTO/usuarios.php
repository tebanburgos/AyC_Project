              	...
              	<div class="leftmenu">
                    <ul>
                        ...
                        if (3==$_SESSION["userinfo"]["userinfo"][1]){
                            echo '<li class="current"><a href="usuarios.php" class="elements"><span>Usuarios</span></a></li>';
                        } 
                        else if (1==$_SESSION["userinfo"]["userinfo"][1] OR 2==$_SESSION["userinfo"]["userinfo"][1]){
                            echo '<li class="current"><a href="usuarios.php" class="elements menudrop"><span>Usuarios</span></a>
                            <ul>
        ...
        <div class="maincontent noright">
        	   <div class="maincontentinner">
                ...
                <ul class="maintabmenu multipletabmenu">
                    <li class="current"><a href="usuarios.php">Usuarios</a></li>
                    <?php
                    if (1==$_SESSION["userinfo"]["userinfo"][1] OR 2==$_SESSION["userinfo"]["userinfo"][1]){
                    echo '<li><a href="agregar_usuario.php">Agregar</a></li>';
                    }?>
                </ul><!--maintabmenu-->
                
                <div class="content">
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Listado Usuarios</span></h2>
                </div><!--contenttitle-->
