        	...
        	<div class="maincontentinner">
                ...
                <div class="content">
                    ...
                    <div class="contenttitle">
                    	<h2 class="chart"><span>Detalle de la venta Cod.<?php echo $_SESSION['tm_vt'][0][0];?></span></h2>
                    </div><!--contenttitle-->
                    
                    <form class="stdform" action="ventas.php" method="">
                    <p>
                    <label class="vendedor">Vendedor: </label><label class="vendedor2"><?php echo $_SESSION['tm_vt'][0][6];?></label>
                    <br />
                    </p>
                    <p>
                    <label class="vendedor">Fecha: </label><label class="vendedor2"><?php echo $_SESSION['tm_vt'][0][9];?></label>
                    <br />
                    </p>
                    <p>
                    <label class="vendedor">Forma de Pago: </label><label class="vendedor2"><?php echo $_SESSION['tm_vt'][0][7];?></label>
                    <br />
                    </p>
                    <p>
                    <label class="vendedor">Observaciones: </label><label class="vendedor2"><?php echo $_SESSION['tm_vt'][0][11];?></label>
                    <br />
                    </p>
                    
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable2" id="dyntable">
                    <colgroup>
                        <col class="con0" />
                        <col class="con1" />
                        <col class="con0" />
                    ...
                    <thead>
                        <tr>
                            <th class="head0">Codigo Venta</th>
                            <th class="head0">Codigo Producto</th>
                            <th class="head1">Nombre</th>
                            <th class="head0">Cantidad</th>
                            <th class="head1">Precio Un</th>
                    ...
                    <?php
                        echo "<tr>";
                        echo "<td>".$_SESSION['tm_vt'][0][0]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][0][1]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][0][2]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][0][3]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][0][4]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][0][5]."</td>";
                        echo "<td></td>";
                        echo "</tr>";
                        $total=$_SESSION['tm_vt'][0][5];
                        for ($i=1;$i<sizeof($_SESSION["tm_vt"]);$i++){
                                $total+=$_SESSION['tm_vt'][$i][5];
                        echo "<tr>";
                        echo "<td></td>";
                        echo "<td>".$_SESSION['tm_vt'][$i][1]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][$i][2]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][$i][3]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][$i][4]."</td>";
                        echo "<td>".$_SESSION['tm_vt'][$i][5]."</td>";
                        echo "<td></td>";
                        echo "</tr>";
