    ...
    <div class="mainwrapper">
        ...
        <div class="mainleft">
          	<div class="mainleftinner">
              	...
              	<div class="leftmenu">
            		<ul>
                        <li class="current"><a href="resumen.php" class="dashboard"><span>Resumen</span></a></li>
                        ...
                        <li><a href="ventas.php" class="editor"><span>Ventas</span></a></li>
        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <ul class="maintabmenu">
                	<li class="current"><a href="dashboard.html">Resumen</a></li>
                </ul><!--maintabmenu-->
                
                <div class="content">
                	
                    <div class="contenttitle">
                    	<h2 class="chart"><span>Productos con bajo stock</span></h2>
                    </div><!--contenttitle-->
                    <br />
